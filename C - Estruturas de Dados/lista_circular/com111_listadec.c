...
int inserir_lista_ordenada(Lista *li, Produto *produto)
{
    if(li == NULL){
        ...
        // como a lista eh circular percorre a lista até o último elemento ("que aponta p/ o primeiro) parando caso encontre codigo maior que o inserido
...
int remover_lista_inicio(Lista *li)
{
  ...
  // percorre a lista e identifica o último elemento
  while(aux->prox != (*li)){
    aux = aux->prox;
  }
